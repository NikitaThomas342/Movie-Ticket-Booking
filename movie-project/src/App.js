...
import Movies from './components/pages/categories/movies'
import MovieDetail from './components/pages/detail/movie_detail'
import Tvshows from './components/pages/categories/tvshows'
import People from './components/pages/categories/peoples'
import TvshowDetail from './components/pages/detail/tvshow_detail'
import PeopleDetail from './components/pages/detail/people_detail'
